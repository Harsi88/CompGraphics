...
void bresenham()
{
    ...
    {     
	    ...
	    //---Scaling r,g,b,a values to (0,1)
	    r0/=255; r1/=255; b0/=255; b1/=255; g0/=255; g1/=255; a1/=255; a0/=255;
    ...
    float dx = x1 - x0;		
    float dy = y1 - y0;
    if(dx==0 && dy==0) continue;	//---Special case when initial and final point is same
...
{ 
    ...
    while(num_of_triangles >= 1)	//--- Iterating for number of triangles
    {
   	fscanf(fp,"%f",&x1);
        ...
        //---Scaling r,g,b,a values to (0,1)
        r3/=255; r2/=255; r1/=255; b3/=255; b2/=255; b1/=255; g3/=255; g2/=255; g1/=255; a3/=255; a2/=255; a1/=255;
	//--- Input Taken
